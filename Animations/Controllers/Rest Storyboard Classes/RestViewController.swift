...
class RestViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    // MARK: - Actions
    @IBAction private func closeRest() {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return view.frame.width + 100 //100 = soma das alturas das labels + altura da linha divisora
    }
...
extension RestViewController: NSFetchedResultsControllerDelegate {
